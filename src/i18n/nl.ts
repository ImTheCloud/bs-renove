...
export const nl: Traductions = {
  ...
  rejoindreEquipe: {
    ...
    intro:
      'Tegelzetter, dakdekker, loodgieter, metselaar… Stel u in twee minuten voor: uw vak, uw ervaring en uw beschikbaarheid. Wij nemen contact op als uw profiel bij onze werven past',
    q1: 'Uw vak',
    q1Aide: 'Meerdere keuzes mogelijk',
    q2: 'Uw profiel',
    experience: 'Ervaring in het vak',
    experiences: ['Minder dan 2 jaar', '2 tot 5 jaar', '5 tot 10 jaar', 'Meer dan 10 jaar'],
    statut: 'U bent',
    statuts: ['Werknemer', 'Zelfstandige', 'In opleiding'],
    langues: 'Talen',
    languesChoix: ['Frans', 'Nederlands', 'Engels', 'Andere'],
    permis: 'Rijbewijs',
    oui: 'Ja',
    non: 'Nee',
    ...
    envoiEnCours: 'Versturen…',
    erreurMetier: 'Kies minstens één vak.',
    erreurChamp: 'Dit veld is verplicht.',
    erreurEmail: 'Dit e-mailadres lijkt niet volledig.',
    ...
    merciTexte:
      'Wij nemen contact op als uw profiel past. Hebt u een cv of foto’s van uw werven? Stuur ze via e-mail of WhatsApp: uw sollicitatie staat er al in.',
    cvEmail: 'Mijn cv via e-mail',
    cvWhatsApp: 'Mijn foto’s via WhatsApp',
    cvIntro: 'Hallo, hier is mijn cv voor mijn sollicitatie via de website:',
    secoursTitre: 'Bijna klaar!',
