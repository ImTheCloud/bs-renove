...
export const fr = {
  ...
  rejoindreEquipe: {
    ...
    intro:
      'Carreleur, couvreur, plombier, maçon… Présentez-vous en deux minutes : votre métier, votre expérience et vos disponibilités. Nous revenons vers vous si votre profil correspond à nos chantiers',
    q1: 'Votre métier',
    q1Aide: 'Plusieurs choix possibles',
    q2: 'Votre profil',
    experience: 'Expérience dans le métier',
    experiences: ['Moins de 2 ans', '2 à 5 ans', '5 à 10 ans', 'Plus de 10 ans'],
    statut: 'Vous êtes',
    statuts: ['Salarié', 'Indépendant', 'En formation'],
    langues: 'Langues parlées',
    languesChoix: ['Français', 'Néerlandais', 'Anglais', 'Autre'],
    ...
    envoiEnCours: 'Envoi…',
    erreurMetier: 'Choisissez au moins un métier.',
    erreurChamp: 'Ce champ est obligatoire.',
    erreurEmail: 'Cette adresse email ne semble pas complète.',
    ...
    merciTexte:
      'Nous revenons vers vous si votre profil correspond. Vous avez un CV ou des photos de vos chantiers ? Envoyez-les par email ou par WhatsApp : votre candidature y est déjà écrite.',
    cvEmail: 'Mon CV par email',
    cvWhatsApp: 'Mes photos par WhatsApp',
    cvIntro: 'Bonjour, voici mon CV pour ma candidature envoyée sur le site :',
    secoursTitre: 'Presque fini !',
